...
const MODULES = [
  ...
  {id:'FM2', phase:'fach', name:'IT-Sicherheitsmanagement & Grundlagen IT-Forensik', ects:7, exam:'Gruppenarbeit 40 % + mündl. Prüfung 60 %', deps:['FM6'],
   ...
   tip:'ISO 27001, BSI 200-1, ISMS-Audit & Zertifizierung. Erstes Modul nach der Sommerpause.',
  ...
  {id:'FM3', phase:'fach', name:'IT-Desaster Recovery & Business Continuity Management', ects:7, exam:'Gruppenarbeit 40 % + mündl. Prüfung 60 %', deps:['FM2'],
   sched:{von:'2027-10-27', bis:'2027-12-14', ex:'2027-12-17', ex2:'2027-12-18'},
   tip:'BSI 200-4, Notfallkonzept, Krisenmanagement. Letztes Fachmodul vor dem Masterarbeits-Seminar.',
  ...
  {id:'FM4', phase:'fach', name:'IT-Risikomanagement & Awareness', ects:7, exam:'Gruppenarbeit 40 % + mündl. Prüfung 60 %', deps:['FM1'],
  ...
  {id:'FM5', phase:'fach', name:'Technologie-Management für Sicherheits- & Risikomanagement', ects:7, exam:'Gruppenarbeit 40 % + mündl. Prüfung 60 %', deps:['FM4'],
   sched:{von:'2027-03-09', bis:'2027-04-27', ex:'2027-04-29', ex2:'2027-04-30'},
   tip:'Asset-/Konfigurationsmanagement (CMDB), Cloud-Systeme, Berechtigungsmanagement.',
  ...
  {id:'FM6', phase:'fach', name:'IT-Recht, -Governance & -Compliance', ects:7, exam:'Gruppenarbeit 40 % + mündl. Prüfung 60 %', deps:['FM5'],
   sched:{von:'2027-05-04', bis:'2027-06-22', ex:'2027-06-25', ex2:'2027-06-26'},
   tip:'IT-Recht, DSGVO, Governance-Referenzmodelle. Danach Sommerpause (Juli–Aug 2027).',
...
const MILESTONES = [
  ...
  {m:'M12',  mm:12, t:'FM4 bestanden, VPS gestartet', mods:['FM4','VPS']},
  {m:'M16',  mm:16, t:'FM5 + FM6 bestanden', mods:['FM5','FM6']},
  {m:'M18',  mm:18, t:'FM2 + FM3 bestanden — alle Fachmodule fertig', mods:['FM2','FM3']},
  ...
  {m:'M24',  mm:24, t:'Masterarbeit eingereicht — Abschluss', mods:['MA']}
];
